...
class RouteGenerator {
     ...
     */
    static generateImports(tableName, className) {
...
import ${tableName}Controller from "../controller/${className}Controller";`;
     ...
     */
    static generateClassDefinition(className, table) {
...
class ${className}Route {
  ...
  private setupRoutes(): void {
     ...
     */
    static generateExportStatement(tableName, className) {
        const lowercasedTableName = tableName.charAt(0).toLowerCase() + tableName.slice(1);
        return `
