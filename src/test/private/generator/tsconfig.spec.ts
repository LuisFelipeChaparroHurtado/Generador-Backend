...
describe("Private Routes", () => {
  ...
  /**
   * Test case for GET /api/private/tsconfig
   * This request tests the tsconfig route, expecting a 200 OK status code.
   * It includes an authorization token in the request header.
   */
